# -*- coding: utf-8 -*-
#
# RPMD documentation build configuration file, created by
...
man_pages = [
    ('contents', 'rpmd', u'RPMD Documentation',
     [u'Joshua W. Allen, Yury V. Suleimanov, William H. Green'], 1)
]
...
texinfo_documents = [
  ('contents', 'RPMD', u'RPMD Documentation',
   u'Joshua W. Allen, Yury V. Suleimanov, William H. Green', 'RPMD', 'One line description of project.',
   'Miscellaneous'),
]
